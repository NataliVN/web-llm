...
### 0. Загрузите файлы проекта

Используйте загрузку файлов через архив  

![Загрузка через github](res/01.png)

Или клонируйте с помощью git (понадобится установка https://git-scm.com/install/)

![Загрузка через vscode](res/02.png)

Откройте папку в VsCode.  

**!!! ВАЖНО !!!**
Путь к вашим проектам не должен содержать русских символов и пробелов! 
